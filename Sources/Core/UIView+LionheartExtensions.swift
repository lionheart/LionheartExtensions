...
extension UIView {
  ...
  /**
     ...
     */
  @available(iOS 9, *)
  public func centerOnXAxis(width: CGFloat? = nil) {
  ...
  /**
     ...
     */
  @available(iOS 9, *)
  public func centerOnYAxis(height: CGFloat? = nil) {
  ...
  @available(iOS 9, *)
  public func fillHorizontalMarginsOfSuperview(margin: CGFloat = 0) {
  ...
  /**
     ...
     */
  @available(iOS 9, *)
  public func fillWidthOfSuperview() {
  ...
  /**
     ...
     */
  @available(iOS 9, *)
  public func fillWidthOfSuperview(margin: CGFloat) {
    guard let superview = superview else {
      return
    }
  ...
  /**
     ...
     */
  @available(iOS 9, *)
  public func fillHeightOfSuperview(margin: CGFloat) {
    guard let superview = superview else {
      return
    }
  ...
  /**
     ...
     */
  @available(iOS 9, *)
  public func fillSuperview(_ axis: NSLayoutConstraint.Axis? = nil, margin: CGFloat = 0) {
    if let axis = axis {
      switch axis {
      case .horizontal:
  ...
  /**
     ...
     */
  @discardableResult
  public func addVisualFormatConstraints(_ format: String, metrics: LayoutDictionary? = nil)
    -> [NSLayoutConstraint]
  {
    let views = ["view": self]
  ...
  /**
     ...
     */
  @discardableResult
  public class func addVisualFormatConstraints(
    _ format: String, metrics: LayoutDictionary? = nil, views: LayoutDictionary
  ) -> [NSLayoutConstraint] {
  ...
  /**
    ...
    - Date: February 17, 2016
    */
  public func distance(toPoint point: CGPoint) -> Float {
  ...
  /**
     ...
     - Date: March 9, 2016
     */
  public func descendantViewsOfType<T>(passingTest test: (T) -> Bool = { _ in true }) -> [T] {
    var views: [T] = []
  ...
  /**
     ...
     - Date: March 9, 2016
     */
  public func lastDescendantViewOfType<T>(passingTest test: (T) -> Bool = { i in true }) -> T? {
